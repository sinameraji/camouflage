...
| CC-4 | `Wizard` | ✅ DONE — `<this commit>` (composes Select/Confirm/Form steps; renderer intercepts sub-modal responses into wizard advance path) | onboarding flow, LSP wizard, command wizard | Multi-step; composes 1+2+3. |
